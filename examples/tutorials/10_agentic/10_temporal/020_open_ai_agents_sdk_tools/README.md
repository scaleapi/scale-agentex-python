...
**Part of the [OpenAI SDK + Temporal integration series](../README.md)** → Previous: [010 Hello World](../010_open_ai_agents_sdk_hello_world/)
...
- OpenAI Agents SDK plugin configured (see [010_hello_world](../010_open_ai_agents_sdk_hello_world/))

## Quick Start

```bash
cd examples/tutorials/10_agentic/10_temporal/020_open_ai_agents_sdk_tools
...
**Next:** [030_open_ai_agents_sdk_human_in_the_loop](../030_open_ai_agents_sdk_human_in_the_loop/) - Add human approval workflows
