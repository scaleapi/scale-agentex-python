...
**Part of the [OpenAI SDK + Temporal integration series](../README.md)** → Previous: [020 Tools](../020_open_ai_agents_sdk_tools/)
...
- Understanding of tools (see [020_tools](../020_open_ai_agents_sdk_tools/))

## Quick Start

```bash
cd examples/tutorials/10_agentic/10_temporal/030_open_ai_agents_sdk_human_in_the_loop
