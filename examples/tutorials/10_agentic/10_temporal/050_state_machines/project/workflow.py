...
class StateMachinesTutorialWorkflow(BaseWorkflow):
    """
    Tutorial demonstrating state machines for managing complex multi-stage agentic workflows.
    """
    def __init__(self):
    ...
    async def on_task_event_send(self, params: SendEventParams) -> None:
        ...
        # Store context for streaming (required by TemporalStreamingModelProvider)
        self._task_id = task.id
        self._trace_id = task.id
        self._parent_span_id = task.id
