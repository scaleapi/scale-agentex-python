...
class TestClient:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_get_root(self, client: AgentexSDK) -> None:
        client_ = client.get_root()
        assert_matches_type(object, client_, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_get_root(self, client: AgentexSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_get_root(self, client: AgentexSDK) -> None:
...
class TestAsyncClient:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_get_root(self, async_client: AsyncAgentexSDK) -> None:
        client = await async_client.get_root()
        assert_matches_type(object, client, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_get_root(self, async_client: AsyncAgentexSDK) -> None:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_get_root(self, async_client: AsyncAgentexSDK) -> None:
